...
const PhoneNumber = () => {
    ...
    return ( 
        <fieldset className="d-flex flex-column">
            ...
            <input value={formState.phoneNumber} name="phoneNumber" className="form-control" placeholder="(000) 000-0000" type="tel" minLength="10" maxLength="10" required onChange={ (e) => updateForm(e)} />
